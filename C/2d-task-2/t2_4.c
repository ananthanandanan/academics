...
void center_case1(int A[][4], int r, int c, int la1, int lb1)
{
    ...
    for (i = 0; i < r; i++)
    {
        for (j = 0; j < c; j++)
        {
            if (((la1 <= (A[i - 1][j - 1] + A[i - 1][j] + A[i - 1][j + 1] + A[i][j - 1] + A[i][j + 1] + A[i + 1][j - 1] + A[i + 1][j] + A[i + 1][j + 1])) && ((A[i - 1][j - 1] + A[i - 1][j] + A[i - 1][j + 1] + A[i][j - 1] + A[i][j + 1] + A[i + 1][j - 1] + A[i + 1][j] + A[i + 1][j + 1]) <= lb1)))
                A[i][j] = 1;
            else
                A[i][j] = 0;
        }
...
void center_case0(int A[][4], int r, int c, int la0, int lb0)
{
    ...
    for (i = 0; i < r; i++)
    {
        for (j = 0; j < c; j++)
        {
            if (((la0 <= (A[i - 1][j - 1] + A[i - 1][j] + A[i - 1][j + 1] + A[i][j - 1] + A[i][j + 1] + A[i + 1][j - 1] + A[i + 1][j] + A[i + 1][j + 1])) && ((A[i - 1][j - 1] + A[i - 1][j] + A[i - 1][j + 1] + A[i][j - 1] + A[i][j + 1] + A[i + 1][j - 1] + A[i + 1][j] + A[i + 1][j + 1]) <= lb0)))
                A[i][j] = 1;
            else
                A[i][j] = 0;
        }
